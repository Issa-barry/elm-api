...
class StoreEncaissementVenteRequest extends FormRequest
{
    ...
    {
        return [
            'facture_vente_id'  => ['required', 'integer', 'exists:factures_ventes,id'],
    ...
    {
        return [
            'facture_vente_id.required' => 'La facture est obligatoire.',
            'facture_vente_id.exists'   => 'La facture sélectionnée n\'existe pas.',
