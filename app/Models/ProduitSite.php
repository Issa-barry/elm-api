...
/**
 * Configuration locale d'un produit pour un point de vente (site).
 *
 * Chaque ligne indique si un produit est activé dans un site donné
 * et permet de surcharger les prix/coûts globaux du produit.
 */
class ProduitSite extends Model
{
